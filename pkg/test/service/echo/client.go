...
type batchOptions struct {
	URLInterceptor util.URLInterceptor
	Count          int
	QPS            int
...
func (o batchOptions) urlInterceptor() util.URLInterceptor {
	if o.URLInterceptor != nil {
		return o.URLInterceptor
	}
	return util.IdentityURLInterceptor
}
...
func newBatch(ops batchOptions) (*batch, error) {
	...
	// Perform url interception.
	u, err := ops.urlInterceptor().InterceptURL(ops.URL)
	if err != nil {
		return nil, err
	}
